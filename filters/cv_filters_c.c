...
{
    "distutils": {
        "name": "filters.cv_filters_c",
        "sources": [
            "filters/cv_filters_c.pyx"
        ]
    },
    "module_name": "filters.cv_filters_c"
}
END: Cython Metadata */
...
#define __PYX_HAVE__filters__cv_filters_c
#define __PYX_HAVE_API__filters__cv_filters_c
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'filters.cv_filters_c' */
...
static __Pyx_memviewslice __pyx_f_7filters_12cv_filters_c_test_filter(__Pyx_memviewslice, PyObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "filters.cv_filters_c"
extern int __pyx_module_is_main_filters__cv_filters_c;
int __pyx_module_is_main_filters__cv_filters_c = 0;

/* Implementation of 'filters.cv_filters_c' */
...
static PyObject *__pyx_pf_7filters_12cv_filters_c_test_filter(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, PyObject *__pyx_v_rgb); /* proto */
...
static PyObject *__pyx_pw_7filters_12cv_filters_c_1test_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_7filters_12cv_filters_c_test_filter(__Pyx_memviewslice __pyx_v_image, PyObject *__pyx_v_rgb, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_width;
  int __pyx_v_height;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  int __pyx_v_g;
  int __pyx_v_b;
  PyObject *__pyx_v_rgb_color = NULL;
  CYTHON_UNUSED PyObject *__pyx_v_empty_array = NULL;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("test_filter", 0);

  /* "filters/cv_filters_c.pyx":7
 * cpdef unsigned char[:, :, :] test_filter(unsigned char [:, :, :] image, rgb):
 *     cdef int width, height, i, j, k, c, r, g, b
 *     r = rgb[2]             # <<<<<<<<<<<<<<
 *     g = rgb[1]
 *     b = rgb[0]
 */
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_rgb, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_As_int(__pyx_t_1); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_r = __pyx_t_2;

  /* "filters/cv_filters_c.pyx":8
 *     cdef int width, height, i, j, k, c, r, g, b
 *     r = rgb[2]
 *     g = rgb[1]             # <<<<<<<<<<<<<<
 *     b = rgb[0]
 *     rgb_color = (r, g, b)
 */
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_rgb, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_As_int(__pyx_t_1); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_g = __pyx_t_2;

  /* "filters/cv_filters_c.pyx":9
 *     r = rgb[2]
 *     g = rgb[1]
 *     b = rgb[0]             # <<<<<<<<<<<<<<
 *     rgb_color = (r, g, b)
 *     width = image.shape[1]
 */
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_rgb, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_As_int(__pyx_t_1); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_b = __pyx_t_2;

  /* "filters/cv_filters_c.pyx":10
 *     g = rgb[1]
 *     b = rgb[0]
 *     rgb_color = (r, g, b)             # <<<<<<<<<<<<<<
 *     width = image.shape[1]
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_r); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_g); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_b); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 10, __pyx_L1_error)
  ...
  __pyx_t_3 = 0;
  __pyx_t_4 = 0;
  __pyx_v_rgb_color = __pyx_t_5;
  __pyx_t_5 = 0;

  /* "filters/cv_filters_c.pyx":11
 *     b = rgb[0]
 *     rgb_color = (r, g, b)
 *     width = image.shape[1]             # <<<<<<<<<<<<<<
 *     height = image.shape[0]
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_empty); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_height); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_width); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_6 = PyList_New(3); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 13, __pyx_L1_error)
 ...
 */
        ...
        if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_image.shape[2];
        __pyx_t_5 = __Pyx_PyInt_From_unsigned_char((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_13 * __pyx_v_image.strides[0]) ) + __pyx_t_14 * __pyx_v_image.strides[1]) ) + __pyx_t_15 * __pyx_v_image.strides[2]) )))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_rgb_color, __pyx_v_k, int, 1, __Pyx_PyInt_From_int, 0, 1, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_6 = PyNumber_Add(__pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_3 = __Pyx_PyInt_RemainderObjC(__pyx_t_6, __pyx_int_255, 0xFF, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __pyx_t_6 = __Pyx_PyNumber_Divide(__pyx_t_3, __pyx_int_2); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_16 = __Pyx_PyInt_As_int(__pyx_t_6); if (unlikely((__pyx_t_16 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __pyx_v_c = __pyx_t_16;

        /* "filters/cv_filters_c.pyx":18
 *             for k in range(0, 3):
 *                 c = (image[j, i, k] + rgb_color[k])%255 / 2
 *                 image[j, i, k] = c             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_image.shape[1];
        if (__pyx_t_13 < 0) __pyx_t_13 += __pyx_v_image.shape[2];
        *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_15 * __pyx_v_image.strides[0]) ) + __pyx_t_14 * __pyx_v_image.strides[1]) ) + __pyx_t_13 * __pyx_v_image.strides[2]) )) = __pyx_v_c;
      }
    }
  }
 ...
 */
  ...
  __Pyx_AddTraceback("filters.cv_filters_c.test_filter", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  ...
  __pyx_L2:;
  __Pyx_XDECREF(__pyx_v_rgb_color);
...
/* Python wrapper */
static PyObject *__pyx_pw_7filters_12cv_filters_c_1test_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_7filters_12cv_filters_c_1test_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("test_filter (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_image,&__pyx_n_s_rgb,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rgb)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("test_filter", 1, 2, 2, 1); __PYX_ERR(0, 5, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "test_filter") < 0)) __PYX_ERR(0, 5, __pyx_L3_error)
      }
    ...
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_rgb = values[1];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("test_filter", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("filters.cv_filters_c.test_filter", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7filters_12cv_filters_c_test_filter(__pyx_self, __pyx_v_image, __pyx_v_rgb);
...
static PyObject *__pyx_pf_7filters_12cv_filters_c_test_filter(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, PyObject *__pyx_v_rgb) {
  ...
  __pyx_t_1 = __pyx_f_7filters_12cv_filters_c_test_filter(__pyx_v_image, __pyx_v_rgb, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 5, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 3, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "filters.cv_filters_c.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "filters.cv_filters_c.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "filters.cv_filters_c.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "filters.cv_filters_c._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"test_filter", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7filters_12cv_filters_c_1test_filter, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cv_filters_c(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cv_filters_c},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcv_filters_c(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcv_filters_c(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cv_filters_c(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cv_filters_c(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cv_filters_c(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cv_filters_c' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cv_filters_c(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cv_filters_c", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_filters__cv_filters_c) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "filters.cv_filters_c")) {
      if (unlikely(PyDict_SetItemString(modules, "filters.cv_filters_c", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init filters.cv_filters_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init filters.cv_filters_c");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
